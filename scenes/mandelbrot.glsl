/// @version 1
/// // Blue
/// uniform vec2 origin;  // =(-0.6299999952316284,-0.41999998688697815) [-2.0,-2.0,0.01]
/// uniform float scale;  // <log> =0.07774548977613449 [0.0,1000,0.01] #0
...
uniform vec2 origin; // =(0.0,0.0) [-2.0,2.0,0.01]
uniform float scale; // <log> =1.0 [0.0,1000,0.01] #0
uniform int n_max; // =100 [1,100,1] #16
